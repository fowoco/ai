...
- T04 packet SHA: recorded after the docs-only sealing commit
...
| T04 | Retrieval domain | ready | T02,T03 | `f13487f540fed74cd336be4aa9df5802aedf7a57` | `task/la-t04-retrieval-domain` | pending | — | — | — | — | — | S2 | proceed | implementation, Evidence, independent verification, merge, T05/T06, S2, external Qdrant/EPS/provider/G1-G7 |
